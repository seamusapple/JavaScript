...
// forEach方法用于遍历 NodeList 的所有成员。它接受一个回调函数作为参数，
// 每一轮遍历就执行一次这个回调函数，用法与数组实例的forEach方法完全一致
var children = document.body.childNodes;
...
// 如果元素节点有id或name属性，那么HTMLCollection实例上面，可以使用id属性或name属性引用该节点元素。
// 如果没有对应的节点，则返回null
...
// 上面代码中，document.images是一个HTMLCollection实例，可以通过<img>元素的id属性值，
// 从HTMLCollection实例上取到这个元素
